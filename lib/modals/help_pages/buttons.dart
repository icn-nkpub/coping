          ...
          child: ListView(
            children: [
              ...
              ModalContainer(
                ...
                child: Column(
                  children: [
                    GoalToggleCard(currentValue: true, title: goals[0], goalIconPath: Assets.icons.cardiology),
                    GoalToggleCard(currentValue: false, title: goals[1], goalIconPath: Assets.icons.mindfulness),
                  ],
                ),
              ),
              const Padding(
