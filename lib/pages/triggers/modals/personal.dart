...
class PersonalTriggerFormModal extends StatefulWidget {
  ...
  @override
  State<PersonalTriggerFormModal> createState() =>
      _PersonalTriggerFormModalState();
}
              ...
              child: Form(
                child: Column(
                  children: [
                    Input(
                        title:
                            AppLocalizations.of(context)!.triggerPersonalLabel,
                        ctrl: cLabel,
                        autocorrect: true),
                    ...
                    FilledButton(
                      onPressed: () async {
                        await context
                            .read<TriggersCubit>()
                            .addPersonal(u!.auth, cLabel.value.text);
